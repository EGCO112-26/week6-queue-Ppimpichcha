...
int dequeue_struct(Queue *q, int customer_count) { //dequeue
    ...
    if (t) {
        ...
        switch(menu_id) {
            case 1: strcpy(menu_name, "Stir-fried Basil with Minced Pork over Rice"); price = 50 * qty; break;
            case 2: strcpy(menu_name, "Fried Chicken with Garlic"); price = 40 * qty; break;
            case 3: strcpy(menu_name, "Pizza"); price =300  * qty; break;
            case 4: strcpy(menu_name, "Chicken Rice (Khao Man Gai)"); price = 60 * qty; break;
